...
jsPsych.plugins["feedback-benev-2"] = (function() {
...
plugin.trial = function(display_element, trial) {
  ...
  // function to determine latent agent intervention or not (picks either the agent weights (1,0) or mine weights (x,1-x))
            ...
            function getWeightBen (intermediate){
              if (intermediate == [1]){ //pick the latent agent weights - for benev agent it is [1,0]
                ...
                final_left  = weights_free_left_b2; //L side
                final_right = weights_free_right_b2; //R side
            }
  ...
  // function to determine feedback (0 or 1)
    ...
    //  console.log('input weight is' + input_weight)
  ...
  function end_trial() {
    ...
    var trial_data = {
      ...
      "mine_prob_win_left": c_weight,  //probability of win for L mine in this block
      "mine_prob_win_right": d_weight,  //probability of win for L mine in this block
