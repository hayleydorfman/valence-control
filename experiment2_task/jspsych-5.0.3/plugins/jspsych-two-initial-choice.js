...
jsPsych.plugins["two-initial-choice"] = (function() {
...
console.log('trial.choices are ' + trial.choices)
    ...
    function after_response(choice) {
      ...
      if (choice == 0){
        mine_chosen = trial.stimuli[0];
      } else {
        mine_chosen = trial.stimuli[1];
      }
