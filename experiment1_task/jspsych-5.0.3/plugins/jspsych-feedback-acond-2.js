...
jsPsych.plugins["feedback-acond-2"] = (function() {
    ...
    // function to determine latent agent intervention or not (picks either the agent weights (1,0) or mine weights (x,1-x))
              ...
              function getWeightBen (intermediate){
                if (intermediate == [1]){ //pick the latent agent weights - for benev agent it is [1,0]
                  ...
                  final_left  = weights_free_left_a2; //L side
                  final_right = weights_free_right_a2; //R side
              }
    ...
    // function to determine feedback (0 or 1)
              ...
              function end_trial() {
                ...
                var trial_data = {
                  ...
                  "mine_prob_win_left": g_weight,  //probability of win for L mine in this block
                  "mine_prob_win_right": h_weight,  //probability of win for L mine in this block
