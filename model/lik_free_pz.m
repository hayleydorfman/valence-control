function [lik,latents] = lik_free_pz(x,data)
    
    % Liklihood function for "Fixed Bayesian" model for Dorfman, et al., 2019
    % This model makes the prob of intervention a free parameter
    ...
    pz = x(3);         % intervention probability
