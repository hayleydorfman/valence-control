function [lik,latents] = lik_rational_adaptive6(x,data)
    
    % Liklihood function for "Adaptive Bayesian" model for Dorfman, et al., 2019
    % Also adds alpha and beta as free params (representing bias
